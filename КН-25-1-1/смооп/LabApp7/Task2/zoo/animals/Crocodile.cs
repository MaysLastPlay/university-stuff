...
namespace LabApp7_2.zoo.animals
{
    internal class Crocodile : Animal
    {
        ...
        public Crocodile(string name, decimal weight, AnimalType type, FoodType foodType, bool canLiveWithOtherAnimals) : base(name, weight, type, foodType, canLiveWithOtherAnimals)
        {
            this.weight = weight;
